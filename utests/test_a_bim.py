...
with warnings.catch_warnings():  
    ...
    from alpm.lp_util.proc import demonstrate_image,\
                               a_from_zip_stream_to_att_data
...
@pytest.mark.asyncio
async def test_changeitpost_basic_iterative_untargeted():
    """
